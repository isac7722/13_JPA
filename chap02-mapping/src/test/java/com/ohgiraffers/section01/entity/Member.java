...
* 또한, "name" 속성을 사용하여 엔티티 클래스와 매필될 테이블의 이름을 지정할 수 있다
* 생략하면 자동으로 클래스 이름을 엔티티명으로 사용한다
*
* - 프로젝트 내에 다른 패키지에도 동일한 엔티티가 존재하는 경우 해당 엔티티를 식별할기 위한 중복 되지 ㅇ나흥ㄴ name을 지정해야 한다
* - 기본 생성자는 필수
* - final 클래스 enum, interface, innerclass 사용 불가능
*
* */
